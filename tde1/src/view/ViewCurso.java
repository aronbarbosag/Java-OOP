...
public class ViewCurso extends JFrame {
	...
	public ViewCurso() {
		...
		btnCriarCurso.setBounds(10, 179, 87, 35);
		btnCriarCurso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Curso novo = new Curso(idCursoInt,nomeCurso);
					daoCurso.adicionarCurso(novo);
					JOptionPane.showMessageDialog(btnCriarCurso, "Curso criado com sucesso!");
					tf_id_curso.setText("");
					...
					JOptionPane.showMessageDialog(btnCriarCurso, e1.getMessage());
				}
